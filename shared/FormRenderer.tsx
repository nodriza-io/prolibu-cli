    ...
    transformed.properties = Object.entries(transformed.properties).reduce(
      (acc, [key, prop]: [string, any]) => {
        ...
        if (!newProp["x-component"]) {
          ...
          } else if (newProp.format === "rich-text") {
            newProp["x-component"] = "RichText";
          } else if (newProp.format === "sections-editor") {
            newProp["x-component"] = "SectionsEditor";
          } else if (newProp.format === "footer-table-editor") {
            newProp["x-component"] = "FooterTableEditor";
          } else {
